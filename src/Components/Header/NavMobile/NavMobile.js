...
export default function NavMobile() {
  ...
  return (
    <div
      ...
      top-0 left-0 bottom-0 z-50 overflow-hidden`}
    >
      <div className="relative w-full h-full">
        ...
        >
          <Link to={"/"} className="pl-5 block mb-10">
            <svg
              width="102"
              height="32"
          ...
          <div className=" py-3 border-t-[1px]  dark:border-gray-700">
            ...
            >
              ...
              <span className="ml-4">Ngôn ngữ</span>
            </button>
            <button
              onClick={() =>
            ...
            >
              {mode === "DARK" ? (
                <>
                  ...
                  <span className="ml-4">Ban ngày</span>
                </>
              ) : (
                <>
                  <BsFillMoonFill className="text-3xl" />
                  <span className="ml-4">Ban đêm</span>
                </>
              )}
            </button>
          </div>
